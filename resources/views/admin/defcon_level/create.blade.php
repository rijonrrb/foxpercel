                        ...
                        <div class="card-body py-5">
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-6 col-xl-4">
                                    <form action="{{ route('admin.defcon-level.store') }}" method="post">
                                        @csrf
                                        <div class="form-group mb-3">
                                            <label for="level" class="form-label">Defcon Level <span class="text-danger">*</span></label>
                                            <input type="text" name="level" value="{{old('level')}}" class="form-control" placeholder="Enter defcon level" required>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="color" class="form-label">Choose Color of Defcon Level <span class="text-danger">*</span></label>
                                            <input type="color" name="color" value="{{old('color')}}" class="form-control" required>
                                        </div>
