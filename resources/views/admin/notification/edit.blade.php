                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-5">
                            <div class="row d-flex justify-content-center">
                                <div class="col-xl-6">
                                    <form action="{{ route('admin.notification.update', $data['row']->id) }}" method="post">
                                        @csrf
                                        <div class="form-group mb-3">
                                            <label for="" class="form-label">Notification Title <span class="text-danger">*</span></label>
                                            <input type="text" name="notification_title" value="{{$data['row']->title}}" class="form-control" required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="" class="form-label">Notification Message <span class="text-danger">*</span></label>
                                            <textarea name="message" id="message" cols="30" rows="5" class="form-control" required>{{$data['row']->message}}</textarea>
                                        </div>
                                        <div class="form-group mb-3">
